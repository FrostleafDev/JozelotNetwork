...
public class ChallengeMenu extends LobbyInventory {
    ...
    public ChallengeMenu(JozelotLobby plugin, Player player) {
        this.plugin = plugin;
        this.lobbyPlayer = plugin.getLobbyPlayerManager().getPlayer(player);

        String title = plugin.getConfig().getString("inventories.challenge_server.title", "Challenge Server");
    ...
    public void update() {
        ...
        // CHALLENGE 2
        setupServerItem(13, "challenge-2_server", new String[]{"challenge-2"}, false);

        // CHALLENGE 3
        setupServerItem(15, "challenge-3_server", new String[]{"challenge-3"}, false);
    }
